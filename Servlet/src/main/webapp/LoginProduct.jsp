...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="product-card">
                ...
                <p class="product-price">Rs.30.99/kg</p>
    ...
    <div id="cart-container">
        <h3>Your Cart</h3>
        <ul id="cart-items" name="productName"></ul>
        <p id="total-price" name="price">Total: Rs.0.00</p>
    </div>
    <button class="btn-view-cart" onclick="toggleCart()">View Cart</button>
    <br>
    <br>
    <form action="ProductLogin.html">
    <button class="btn-view-cart">Login to Order</button><br><br>
    <p>Don't have an account? <a href="ProductSignup.html">Sign Up</a></p>
    </form>
</div>
